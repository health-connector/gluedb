    ...
    def publish
      ...
      existing_policy.enrollees.each do |en|
        ...
        if termination.all_member_ids.include?(en.m_id)
          active_dependents_from_term << en.m_id if en.coverage_end.blank?
        end
      end
      ...
      termination_helper.recalculate_premium_totals_excluding_dropped_dependents(active_dependents_from_term)
